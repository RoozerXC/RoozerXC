...
class cLuxPlayerRanged : public iLuxPlayerHelper
{
public:	
	cLuxPlayerRanged(cLuxPlayer *apPlayer);
	~cLuxPlayerRanged();
	...
	void SetActive(bool abX, bool abUseEffects, bool abCheckForItem=true, bool abCheckIfAllowed=true);
	bool IsActive(){ return mbActive;}
