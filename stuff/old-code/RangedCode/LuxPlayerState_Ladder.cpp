...
void cLuxPlayerState_Ladder::OnEnterState(eLuxPlayerState aPrevState)
{
	...
	/////////////////////////////////////
	// Holster ranged
	mbRangedDrawn = mpPlayer->GetHelperRanged()->IsActive();
	mpPlayer->GetHelperRanged()->SetActive(false,true,true, false);
...
void cLuxPlayerState_Ladder::OnLeaveState(eLuxPlayerState aNewState)
{
	...
	/////////////////////////////////////
	// Draw ranged if it was before
	if(mbRangedDrawn)
        mpPlayer->GetHelperRanged()->SetActive(true, true, true, false);
}
