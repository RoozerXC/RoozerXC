...
static cLuxAction gvLuxActions[] =
{
	...
	cLuxAction("Ranged",eLuxAction_Ranged,		true, eLuxActionCategory_Action),
...
static cLuxInput gvLuxInputs[] =
{
	...
	cLuxInput("Keyboard", eKey_K, eLuxAction_Ranged),
...
void cLuxInputHandler::UpdateGamePlayerInput()
{
	...
	//Ranged
	if(mpInput->BecameTriggerd(eLuxAction_Ranged))	mpPlayer->DoAction(eLuxPlayerAction_Ranged ,true);
	if(mpInput->WasTriggerd(eLuxAction_Ranged))	mpPlayer->DoAction(eLuxPlayerAction_Ranged, false);
